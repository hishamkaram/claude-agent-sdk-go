...
"claude-agent-sdk-go security report".
...
The SDK starts a local Claude Code process with the caller's authority. Review
its permission settings; do not expose it directly to untrusted callers.
